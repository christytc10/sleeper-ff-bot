...
def get_trending_players():
    ...
    return json.dumps({
      "content": "Trending Players (last 24 hours)",
      "embeds": [
        {
          "description": "RB - Chicago Bears",
          "color": 7506394,
          "author": {
            "name": "1. Ryan Nall",
            "icon_url": "https://sleepercdn.com/content/nfl/players/thumb/5163.jpg"
          },
          "footer": {
            "text": "200 adds"
          }
        ...
        {
          "description": "TE - New Orleans Saints",
          "author": {
            "name": "2. Jared Cook",
            "icon_url": "https://sleepercdn.com/content/nfl/players/thumb/5163.jpg"
          },
